      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {restaurantes && restaurantes.length > 0 ? (
                ...
                {restaurantes.map((r) => (
                  <tr key={r.id} className="border-b border-gray-50 hover:bg-gray-50 transition">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{ backgroundColor: r.color_principal }}
                        >
                          {r.nombre.charAt(0)}
                        </div>
                        <div>
                    ...
                    <td className="px-6 py-4">
                        ...
                        <a href={"http://" + r.subdominio + ".localhost:3000"}
                        target="_blank"
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
            ...
            <Link
              href="/admin/restaurantes/nuevo"
              className="inline-block mt-4 bg-red-500 text-white px-6 py-2.5 rounded-xl text-sm font-medium hover:bg-red-600 transition"
            >
